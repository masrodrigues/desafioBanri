...
public class ReportFactory {
    ...
    public static void configReportExtent() {
        ...
        extentSparkReporter.config().setJs("$('.nav-logo').html('<img src=\"https://i.imgur.com/MlNEHC2.png\" class=\"logo-bugbank\" style=\"margin-left: 250px; width: 100px; height: auto;\"/>');");
